  ...
  return (
    <div
      className={[
        ...
        '[&_h2]:mt-10 [&_h2]:mb-5 [&_h2]:border-b [&_h2]:border-white/10 [&_h2]:pb-3 [&_h2]:text-[2.05rem] [&_h2]:font-semibold [&_h2]:text-white',
        '[&_h3]:mt-8 [&_h3]:mb-3 [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-white/95',
        ...
        '[&_table]:my-6 [&_table]:w-full [&_table]:table-fixed [&_table]:border-collapse [&_table]:border [&_table]:border-white/10 [&_table]:bg-white/[0.02]',
        ...
        '[&_th:nth-child(1)]:w-[15%] [&_td:nth-child(1)]:w-[15%]',
        '[&_th:nth-child(2)]:w-[24%] [&_td:nth-child(2)]:w-[24%]',
        '[&_th:nth-child(3)]:w-[22%] [&_td:nth-child(3)]:w-[22%]',
        '[&_th:nth-child(4)]:w-[17%] [&_td:nth-child(4)]:w-[17%]',
        '[&_th:nth-child(5)]:w-[10%] [&_td:nth-child(5)]:w-[10%]',
        '[&_th:nth-child(6)]:w-[12%] [&_td:nth-child(6)]:w-[12%]',
        '[&_img]:rounded-xl [&_img]:border [&_img]:border-white/10 [&_img]:bg-black/20 [&_img]:shadow-lg',
      ].join(' ')}
